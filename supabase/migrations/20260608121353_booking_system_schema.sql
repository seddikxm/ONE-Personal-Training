-- ============================================
-- FITNESS CLASS BOOKING SYSTEM — SCHEMA
-- ============================================
...
-- APPOINTMENTS: public can insert but NOT select
...
-- BUSINESS HOURS
CREATE POLICY "public_select_hours" ON business_hours
  FOR SELECT USING (true);
CREATE POLICY "admin_all_hours" ON business_hours
  FOR ALL USING (is_admin());

-- BLOCKED DATES
CREATE POLICY "public_select_blocked" ON blocked_dates
  FOR SELECT USING (true);
CREATE POLICY "admin_all_blocked" ON blocked_dates
  FOR ALL USING (is_admin());

-- BUSINESS SETTINGS
CREATE POLICY "public_select_settings" ON business_settings
  FOR SELECT USING (true);
CREATE POLICY "admin_all_settings" ON business_settings
  FOR ALL USING (is_admin());
